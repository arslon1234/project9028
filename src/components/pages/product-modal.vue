          ...
          <div class="modal__form-img">
            ...
            <p class="login__input-error" v-if="errors && errors.length">
             ...
             <Field
                ...
                name="Arrival price"
              >
            <input class="form__input" type="text" id="arrival_price" placeholder="Arrival price" v-model="forms.current_arrival_price">
            <p class="login__input-error" v-if="errors && errors.length">
               {{ errors[0] }}
             </p>
              </Field>
             ...
             <Field
                ...
                name="Selling price"
              >
            <input class="form__input" type="text" id="selling_price" placeholder="Selling price" v-model="forms.current_selling_price">
            <p class="login__input-error" v-if="errors && errors.length">
               {{ errors[0] }}
             </p>
             </Field>
...
async function send(event) {
 ...
 try {
  ...
  dialog.value = false
  Notification({ text: "Product updated !!!" },{type: 'success'})
 } catch(err) {
   console.log(err);
...
async function deleteProduct () {
  try{
    ...
    Notification({ text: "Product deleted !!!" },{type: 'success'})
   dialog2.value = false
  }catch(err){
    console.log(err)
    Notification({ text: "Something wrong !!!" },{type: 'danger'})
